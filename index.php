...
<div class="d-flex">
    <div class="sidebar col-md-2 d-none d-md-block">
        ...
        <a href="index.php?page=simpanan_sihara"><i class="fas fa-wallet me-2"></i> Rekap Sihara</a>
        <a href="index.php?page=simpanan_simjib"><i class="fas fa-file-invoice-dollar me-2"></i> Rekap Simjib</a>
        <a href="index.php?page=simpanan_simpok"><i class="fas fa-coins me-2"></i> Rekap Simpok</a>

        <?php if($user['role'] == 'admin' || $user['role'] == 'staff'): ?>
        <div class="nav-header">Kas & Keuangan</div>
        <a href="index.php?page=kas_penjualan"><i class="fas fa-cash-register me-2"></i> Penjualan Harian</a>
        <a href="index.php?page=kas_belanja"><i class="fas fa-shopping-cart me-2"></i> Belanja Stok</a>
        <a href="index.php?page=laporan_kas"><i class="fas fa-book me-2"></i> Laporan Arus Kas</a>
        <?php endif; ?>

        <div class="nav-header">Konsinyasi</div>
        <a href="index.php?page=titipan"><i class="fas fa-box-open me-2"></i> Titipan Guru</a>

        <div class="nav-header">Stok Seragam</div>
        <a href="index.php?page=stok_sekolah"><i class="fas fa-tshirt me-2"></i> Seragam Sekolah</a>
        <a href="index.php?page=stok_eskul"><i class="fas fa-user-astronaut me-2"></i> Seragam Eskul</a>
